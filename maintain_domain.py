    ...
    def do_GET(self):
        ...
        if self.path == '/':
            ...
            for record in records_nf:
                if idx % 5 == 0:
                    response_content += '<td width="300">' + record + '</td> </tr><tr>'
                else:
                    response_content += '<td width="300">' + record + '</td>'
                idx += 1
            response_content += '</tr>'
            response_content += '</table>'
            ...
            for record in records:
                ...
                r2 = record.split(" ")[1]
                response_content += '<tr>'
                response_content += '<td width="400">' +  r1 + '</td> <td width="100">' + r2 + '</td> <td width="100"> <a href="/delete?record=' + record + '">删除</a>  </td> '
                response_content += '</tr>'
            response_content += '</table>'
            response_content += '</ul>'
